...
export default function DatabaseAdmin() {
  ...
  return <Layout title="Database Admin" subtitle="View all database tables and statistics">
    <div className="grid md:grid-cols-4 gap-4 mb-8">
      ...
      <div className="rounded-2xl bg-white p-6 shadow-soft border flex items-center gap-4">
        <div className="h-12 w-12 rounded-xl bg-red-100 grid place-items-center"><span className="text-red-600 font-bold">Rs</span></div>
    ...
    {activeTab === 'users' && <div className="max-w-full overflow-x-auto rounded-3xl bg-white shadow-soft border">
    ...
    {activeTab === 'products' && <div className="max-w-full overflow-x-auto rounded-3xl bg-white shadow-soft border">
    ...
    {activeTab === 'sales' && <div className="max-w-full overflow-x-auto rounded-3xl bg-white shadow-soft border">
