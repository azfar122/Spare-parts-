          ...
          <div className="ml-auto flex items-center gap-4">
            {user?.role === "admin" && (
              <div className="flex gap-2">
                <Link
                  to="/admin"
                  className={`rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition ${location.pathname === "/admin" ? "bg-white/20" : "hover:bg-white/10"}`}
                >
                  <Store size={16} />
                  Inventory
                </Link>
                <Link
                  to="/admin/sales"
                  className={`rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition ${location.pathname === "/admin/sales" ? "bg-white/20" : "hover:bg-white/10"}`}
                >
                  <BarChart3 size={16} />
                  Sales
                </Link>
                <Link
                  to="/admin/customers"
                  className={`rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition ${location.pathname === "/admin/customers" ? "bg-white/20" : "hover:bg-white/10"}`}
                >
                  <BookOpen size={16} />
                  Khata
                </Link>
                <Link
                  to="/admin/warehouses"
                  className={`rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition ${location.pathname === "/admin/warehouses" ? "bg-white/20" : "hover:bg-white/10"}`}
                >
                  <Building2 size={16} />
                  Warehouse
                </Link>
                <Link
                  ...
                  className={`rounded-lg px-4 py-2 text-sm font-medium flex items-center gap-2 transition ${location.pathname === "/admin/purchase-orders" ? "bg-white/20" : "hover:bg-white/10"}`}
                >
                  <Package size={16} />
                  Orders
                </Link>
            ...
            <span className="text-sm bg-white/10 px-3 py-2 rounded-full flex items-center gap-2">
              <ShieldCheck size={16} />
              {user?.role}
            </span>
            <button
              onClick={logout}
              className="no-print rounded-xl bg-white/10 hover:bg-white/20 px-4 py-2 text-sm flex gap-2"
            >
              <LogOut size={16} />
              Logout
            </button>
